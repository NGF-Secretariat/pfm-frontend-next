        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div className="space-y-5 min-w-0">
            <p className="text-xl sm:text-2xl font-bold leading-relaxed text-[#1D9E75]">
              This is an open source database of the fiscal data of the 36 state
              governments of Nigeria.
            </p>
            <p className="leading-relaxed text-gray-600">
              The portal hosts comparable annual data on government spending,
              revenues, and financing. It also features hundreds of performance
              indicators that measure the quality of public spending and the
              intersection of public financial management and service delivery.
            </p>
            <p className="leading-relaxed text-gray-600">
              All data published are sourced from State government budget
              documents and audited financial statements, and presented in line
              with the National Chart of Accounts (NCOA).
            </p>
          </div>

          <div className="w-full min-w-0 flex flex-col gap-4">
            <div className="w-full relative bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6 min-h-[420px]">
              {loadingMap ? (
                <div className="grid h-[520px] place-items-center text-sm text-gray-500">
                  Loading state expenditure…
                </div>
              ) : error ? (
                <div className="grid h-[520px] place-items-center px-6 text-center text-sm text-red-600">
                  {error}
                </div>
              ) : !hasMapData ? (
                <div className="grid h-[520px] place-items-center px-6 text-center text-sm text-gray-500">
              ...
              <div className="absolute bottom-3 right-3 w-44 sm:w-52 bg-white/95 backdrop-blur rounded-xl border border-gray-100 shadow-md p-3 z-10">
