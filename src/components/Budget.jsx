    ...
    const nav = [
        {
            ...
            href: "/group-explorer/?type=original&categories=all&states=all",
        ...
        },
        {
            ...
            href: "/group-explorer/?type=actual&categories=all&states=all",
        ...
        },
        {
            ...
            href: "/group-explorer/?type=pi&categories=all&states=all",
        ...
        },
        {
            ...
            href: "/group-explorer/?type=revised&categories=all&states=all",
                ...
                <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                    {nav?.map((card) => (
                        <Link
                            key={card.title}
                            href={card.href}
                            className="bg-white rounded-xl border-[1.5px] border-[#e8ede8] p-7 flex flex-col gap-3 transition-all duration-200 hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 cursor-pointer no-underline block"
