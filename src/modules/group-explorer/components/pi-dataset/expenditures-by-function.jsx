...
const initialValues = ["expenditure_by_function"];
const ExpendituresByFunction = ({ data, categories = [] }) => {
  ...
  React.useEffect(() => {
    const data = getAllCategories(BUDGET_CATEGORIES__PI[13].children);
    setOptions((prev) => [...prev, ...data]);
    //eslint-disable-next-line
  }, []);

  const name = "expenditure_by_function";
...
export default ExpendituresByFunction;
