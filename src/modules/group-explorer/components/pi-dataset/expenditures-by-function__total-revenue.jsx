...
const initialValues = ["expenditure_by_function_percentage_total_revenue"];
const ExpendituresByFunctionTotalRevenue = ({ data, categories = [] }) => {
  ...
  const name = "expenditure_by_function_percentage_total_revenue";
  ...
  return (
    <React.Fragment>
      ...
      <AppTableCell
        titleClass=""
        title="General Public Service Total Expenditure (% of Total Revenue)"
        values={data.map(
      ...
      <AppTableCell
        titleClass=""
        title="Public Order and Safety Total Expenditure (% of Total Revenue)"
        values={data.map(
      ...
      <AppTableCell
        titleClass=""
        title="Economic Affairs Total Expenditure (% of Total Revenue)"
        values={data.map(
      ...
      <AppTableCell
        titleClass=""
        title="Environmental Protection Total Expenditure (% of Total Revenue)"
        values={data.map(
      ...
      <AppTableCell
        titleClass=""
        title="Housing and Community Affairs Total Expenditure (% of Total Revenue)"
        values={data.map(
      ...
      <AppTableCell
        titleClass=""
        title="Health Total Expenditure (% of Total Revenue)"
        values={data.map((item) => item[name]?.health_total_expenditure)}
        isVisible={filterCategories.includes(name)}
      />
      <AppTableCell
        titleClass=""
        title="Recreation and Culture Total Expenditure (% of Total Revenue)"
        values={data.map((item) => item[name]?.recreation_total_expenditure)}
        isVisible={filterCategories.includes(name)}
      />
      <AppTableCell
        titleClass=""
        title="Education Total Expenditure (% of Total Revenue)"
        values={data.map((item) => item[name]?.education_total_expenditure)}
        isVisible={filterCategories.includes(name)}
      />
      <AppTableCell
        titleClass=""
        title="Social Protection Total Expenditure (% of Total Revenue)"
        values={data.map(
...
export default ExpendituresByFunctionTotalRevenue;
